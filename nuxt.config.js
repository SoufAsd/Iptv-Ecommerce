export default {
  ...
  head: {
    title:
      "Digital Land - Meilleur IPTV au France | Abonnement Koora IPTV France",
    titleTemplate:
      "Digital Land | Meilleur IPTV au France | Abonnement Koora IPTV France",
    meta: [
      { charset: "utf-8" },
      ...
      {
        hid: "Digital Land : Meuble, Déco, High Tech, Bricolage, Jardin, Sport | Livraison gratuite à partir de 25€ | Paiement sécurisé | 4x possible | Retour simple et rapide | E-commerçant français, des produits et services au meilleur prix.",
        name: "description",
        content: "",
      },
    ],
  ...
  auth: {
    ...
    strategies: {
      google: {
        clientId:
          "619518220362-cacdb3tks7nhra1eutrbjq78q13ikbb1.apps.googleusercontent.com",
        codeChallengeMethod: "",
        responseType: "code",
        endpoints: {
      ...
      local: {
        ...
        endpoints: {
          login: { url: "/api/loginregister", method: "post" },
          logout: true,
          user: { url: "/api/client/infos", method: "get" },
        },
      },
    },
  },
